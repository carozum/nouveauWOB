...
if (isset($_POST['Email'])) {
    ...
    // $email_to = "webcomeonboard@gmail.com";
    $email_to = "czumbiehlfaure@hotmail.fr";
    $email_subject = "New form submissions in WOB";
    ...
    $message = sanitize_textarea_field($_POST['Message']); // required
